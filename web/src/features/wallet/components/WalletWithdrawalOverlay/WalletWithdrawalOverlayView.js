...
import inputStyles from "../../../../shared/styles/InputStyles.module.css";
import ExitOverlayButton from "../../../../shared/components/ExitOverlayButton/ExitOverlayButton";
import { formatBalance, handleAmountOnChange, handleAmountOnBlur } from "../../utils/WalletHelpFunctions";
...
export default function WalletWithdrawalOverlay({ 
    ...
    const payoutAccount = savedPayoutAccounts.find(
        account => account.id === selectedPayoutAccount
    );
    ...
    return (
        <div className={styles.content}>
            ...
            >
                <div>
                    <div style={{ marginBottom: ".1rem" }}>Selected payout account</div>
                    {payoutAccount ? (
                    <>
                        <div>Payout method: {payoutAccount.payoutMethod}</div>
                        <div>Account number: {payoutAccount.number}</div>
                    </>
                    ) : (
